...
How it works
------------
* Target metadata is pulled directly from the SQLAlchemy ORM Base defined in
  MythosEngine/storage/sqlite_backend.py, so autogenerated migrations always
  reflect the live model definitions.
...
from MythosEngine.storage.sqlite_backend import Base  # noqa: E402
